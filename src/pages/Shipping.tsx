...
const highlights = [
  {
    ...
    desc: "We deliver to all major towns across Kenya.",
  },
  {
    icon: Gift,
    title: "Free Shipping Over KSh 5,000",
    desc: "Orders above KSh 5,000 qualify for free delivery.",
  },
  {
    icon: Clock,
  ...
  },
  {
    ...
    desc: "Track your order in real-time using your order number.",
  },
];
